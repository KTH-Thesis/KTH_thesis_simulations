...
function [c,ceq] = constraints_1(t_1, e_1, u_1)
    ...
    c(1) = (obs(1,3) + r(1,1))^2 - (e_1(1)+des_1(1) - obs(1,1))^2 - (e_1(2)+des_1(2) - obs(1,2))^2;
    ...
    if n_1 * n_2 ~= 0
      ...
      for i=1:n_1
        c(i + 1) = (r(1) + r(2))^2 - ...
          (x_open_loop_1(i,1) + des_1(1) - x_open_loop_2(i,1) - des_2(1))^2 -...
          (x_open_loop_1(i,2) + des_1(2) - x_open_loop_2(i,2) - des_2(2))^2;
      end
...
function [c,ceq] = constraints_2(t_2, e_2, u_2)
    ...
    c(1) = (obs(1,3) + r(2,1))^2 - (e_2(1)+des_2(1) - obs(1,1))^2 - (e_2(2)+des_2(2) - obs(1,2))^2;
    ...
    if n_1 * n_2 ~= 0
      ...
      for i=1:n_2
        c(i + 1) = (r(1) + r(2))^2 - ...
          (x_open_loop_2(i,1) + des_2(1) - x_open_loop_1(i,1) - des_1(1))^2 -...
          (x_open_loop_2(i,2) + des_2(2) - x_open_loop_1(i,2) - des_1(2))^2;
      end
