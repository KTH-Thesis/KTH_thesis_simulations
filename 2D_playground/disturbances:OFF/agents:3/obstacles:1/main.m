...
function [c,ceq] = constraints_1(t_1, e_1, u_1)
  ...
  if n_3 > 0
    ...
    if method == 1
      ...
      c(6) = d_min^2 - dist_x^2 - dist_y^2;

      % Maintain connectivity with agent 3
      c(7) = dist_x^2 + dist_y^2 - d_max^2;
    ...
    elseif method == 2
      ...
      for i=1:2
        ...
        c(5 + i) = d_min^2 - dist_x^2 - dist_y^2;
      end
      ...
      % Maintain connectivity with agent 3 along the entire horizon
       for i=1:2
         ...
         c(5 + 2 + i) = sqrt(dist_x^2 + dist_y^2) - d_max;
       end
...
function [c,ceq] = constraints_3(t_3, e_3, u_3)
  ...
  ceq = [];
   ...
   c(1) = (obs(1,3) + r(2) + ptol)^2 - (e_3(1)+des_3(1) - obs(1,1))^2 - (e_3(2)+des_3(2) - obs(1,2))^2;
