function main
  ...
  fig_1 = plot_results(total_iterations, T, tT_1, des_1, xX_1, uU_1, obs, 1);

  % Plot trajectory of agent 2
  fig_2 = plot_results(total_iterations, T, tT_2, des_2, xX_2, uU_2, obs, 2);
