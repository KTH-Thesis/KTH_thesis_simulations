...
function [c,ceq] = constraints_1(t_1, e_1, u_1)
    ...
    if n_1 * n_2 ~= 0
      ...
      for i=1:n_1
        c(i + 1) = (r(1) + r(2))^2 - ...
          (x_open_loop_1(1) + des_1(1) - x_open_loop_2(i,1) - des_2(1))^2 -...
          (x_open_loop_1(2) + des_1(2) - x_open_loop_2(i,2) - des_2(2))^2;
      end

      % Keep connectivity with agent 2 along the entire horizon
      for i=1:n_1
        c(i + 1 + n_1) = ...
          (x_open_loop_1(1) + des_1(1) - x_open_loop_2(1,1) - des_2(1))^2 +...
          (x_open_loop_1(2) + des_1(2) - x_open_loop_2(1,2) - des_2(2))^2 - ...
          0.3^2;
      end
