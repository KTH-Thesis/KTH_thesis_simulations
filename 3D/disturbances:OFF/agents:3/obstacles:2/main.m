...
function [c,ceq] = constraints_1(t_1, e_1, u_1)
  ...
  for i = 1:2
    c(i) = (obs(i,3) + r(1) + otol)^2 - ((e_1(1)+des_1(1) - obs(i,1))^2 + (e_1(2)+des_1(2) - obs(i,2))^2);
  end
...
function [c,ceq] = constraints_3(t_3, e_3, u_3)
  ...
  for i = 1:2
    c(i) = (obs(i,3) + r(2) + otol) - sqrt((e_3(1)+des_3(1) - obs(i,1))^2 + (e_3(2)+des_3(2) - obs(i,2))^2);
  end

  c(3) = e_3(3) + des_3(3) - pi;
  c(4) = -e_3(3) - des_3(3) - pi;
