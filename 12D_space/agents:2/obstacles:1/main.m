...
function [c,ceq] = constraints_1(t_1, e_1, u_1)
  ...
  c(1) = (obs(1,4) + r(1) + ptol) - ...
    sqrt( (e_1(1)+des_1(1) - obs(1,1))^2 ...
      + (e_1(2)+des_1(2) - obs(1,2))^2 ...
      + (e_1(3)+des_1(3) - obs(1,3))^2 );

  c(2) = e_1(4) + des_1(4) - pi/2;
  c(3) = -pi/2 - e_1(4) + des_1(4);
  ...
  if n_2 > 0
    ...
    if point_in_horizon <= point_in_horizon_ceiling;
      ...
      dist_z = e_1(3) + des_1(3) - x_open_loop_2_cut(point_in_horizon,3) - des_2(3);
...
function [c,ceq] = constraints_2(t_2, e_2, u_2)
  ...
  c(1) = (obs(1,4) + r(1) + ptol) - ...
    sqrt( (e_2(1)+des_2(1) - obs(1,1))^2 ...
    + (e_2(2)+des_2(2) - obs(1,2))^2 ...
    + (e_2(3)+des_2(3) - obs(1,3))^2 );

  c(2) = e_2(4) + des_2(4) - pi/2;
  c(3) = -pi/2 - e_2(4) + des_2(4);
  ...
  if n_1 > 0
    ...
    if point_in_horizon <= point_in_horizon_ceiling
      ...
      dist_z = e_2(3) + des_2(3) - x_open_loop_1_cut(point_in_horizon,3) - des_1(3);
      dist = sqrt(dist_x^2 + dist_y^2 + dist_z^2);
